/**
* @description This file will read queue messages and 
...
// readQueue().then(result => { console.log(result) }).catch(error => { console.log(error) });
...
async function sortMessages(msgObj) {
    ...
    switch (msgObj?.text?.step) {
        ...
        // we want to take the result of here and put it entity() and will track that in main.
        case "body":
